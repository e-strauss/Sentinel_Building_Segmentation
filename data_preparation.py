...
def create_dataset_for_building_segmentation(cities):
    ...
    custom = True
    custom_samples_per_city = {"Dresden": 50, "Leipzig": 50, "Hamburg": 150, "Paris": 200, "London": 250, "Erfurt": 50}
    ...
    if nr_samples == 100:
        ...
        minimum_share_of_buildings = {"Dresden": 0.17, "Leipzig": 0.142, "Hamburg": 0.21, "Hannover": 0.185,
                                      "Muenchen": 0.21, "Paris": 0.245, "London": 0.248, "Erfurt": 0.15}
    for city in cities:
        if custom:
            nr_samples = custom_samples_per_city.get(city, 100)
